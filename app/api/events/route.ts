...
export async function GET(request: NextRequest) {
  ...
  try {
    ...
    const query: DiscoveryQuery = {
      ...
      sectorThemes: [...values(params, "industry"), ...values(params, "sectorTheme")],
      ...
      targetAudience: values(params, "targetAudience"),
      companyParticipants: values(params, "companyParticipants"),
      eventFeatures: values(params, "eventFeatures"),
      accessModel: values(params, "accessModel"),
      marketCap: values(params, "marketCap"),
