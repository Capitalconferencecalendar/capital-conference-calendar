  ...
  return (
    <div className="v3-page">
      <style jsx>{`
        ...
        .v3-readout { position: relative; display: grid; align-items: start; min-height: 280px; height: max-content; padding: 24px 34px 26px; border: 1px solid rgba(213,226,240,.08); border-radius: 22px; background: radial-gradient(circle at 80% 18%,rgba(51,112,160,.26),transparent 36%), linear-gradient(132deg,#030b16 0%,#06182a 43%,#08111f 100%); box-shadow: inset 0 1px 0 rgba(245,250,255,.16), inset 0 -1px 0 rgba(112,146,180,.1), 0 24px 54px rgba(0,0,0,.34), 0 0 48px rgba(144,178,211,.13); }
